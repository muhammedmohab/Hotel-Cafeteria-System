                            ...
                            echo "
                               <td>";
                                  if($Order['status']!='Finished' || empty($Order['finshed_at'])){
                                    echo"
                                    <a class='genric-btn info circle small py-1' href='allOrders.php?id=$id' role='button' data-bs-toggle='modal' data-bs-target='#exampleModal'>Update Status</a>";
                                  }
                                  echo"
                                    <form class='d-inline mx-2' action='../Controllers/OrderController.php' method='post' >
