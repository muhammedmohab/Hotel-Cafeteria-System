      ...
      <div class="col text-center">
        ...
        <form id="theForm">
          <div class="row justify-content-center  d-flex mb-3">
            ...
            <div class="col">
              <button type="button" class="genric-btn info circle" onclick="resetfun()">reset</button>
              <button type="button" class="genric-btn primary circle search" onclick="myFunction()">search</button>
          ...
          <tbody class="bg-light">
            ...
            foreach ($allOrders as $index => $Order) {
              ...
              if ($Order['status'] == 'In-Progress') {
                ...
                echo "<a class='genric-btn danger circle small py-1' style='color:white' role='button' data-bs-toggle='modal' data-bs-target='#DeleteModal' data-id='$id'>Cancel</a>";
                ...
                //         <input class='genric-btn danger circle small py-1' onclick='return confirm('Are you sure you want to cancel this order?')' type='submit' value='Cancel'>
                //     </form>";
              }
              "
        ...
        <div class="modal-body">
          <form action="../Controllers/OrderController.php" method="post">
            ...
            <div class="d-flex justify-content-around" >
              <button type="submit" class="mb-2 genric-btn primary circle col-5">Update</button>
              <button type="button" class="mb-2 genric-btn danger circle col-5" data-bs-dismiss="modal" aria-label="Close">Cancel</button>
            </div>
        ...
        <div class="modal-body">
          <div>
            ...
            <div class="d-flex mt-4 justify-content-around " >
              <a href="" class="btn btn-block mb-2 genric-btn primary circle col-5" data-bs-dismiss="modal" aria-label="Close">Close</a>
              <form class='d-inline col-5 ' action='../Controllers/OrderController.php' method='post'>
                <input type='hidden' value='$id' name='orderId'>
                <input type='hidden' name='validationType' value='cancelOrder'>
                <input class="btn btn-block mb-2 genric-btn danger circle" type='submit' value='Delete'>
              </form>
            </div>
          </div>
        </div>
